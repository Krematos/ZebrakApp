...
@Schema(description = "Formulář pro úpravu existujícího místa")
@Data
@Builder
@NoArgsConstructor
@AllArgsConstructor
public class PlaceUpdateRequest {
    ...
    @Schema(description = "Název místa / podniku", example = "Restaurace U Žebráka (Upraveno)", requiredMode = Schema.RequiredMode.REQUIRED)
    @NotBlank(message = "Název místa je povinný")
    @Size(min = 2, max = 255, message = "Název místa musí mít 2 až 255 znaků")
    private String title;

    @Schema(description = "Popis místa a nabízené slevy", example = "Každý čtvrtek od 17:00 pivo 1+1 zdarma.")
